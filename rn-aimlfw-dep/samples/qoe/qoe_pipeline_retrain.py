...
def train_export_model(featurepath: str, epochs: str, modelname: str, modelversion:str):
    ...
    url = f"http://modelmgmtservice.ridenext-ai-platform:8082/ai-ml-model-discovery/v1/models/?model-name={modelname}&model-version={modelversion}"
    ...
    if modelinfo["modelLocation"] != "":
        ...
        model_url = f"http://tm.ridenext-ai-platform:32002/model/{keras_model}/{modelversion}/{artifactversion}/Model.zip"
...
# update artifact version
    ...
    url = f"http://modelmgmtservice.ridenext-ai-platform:8082/ai-ml-model-registration/v1/model-registrations/updateArtifact/{modelname}/{modelversion}/{new_artifactversion}"
...
requests.post("http://tm.ridenext-ai-platform:32002/pipelines/{}/upload".format(pipeline_name), files={'file':open(pipeline_file,'rb')})
