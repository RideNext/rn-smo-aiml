...
{{- define "common.servicehost.data-extraction.http" -}}data-extraction.ridenext-ai-platform{{- end -}}
{{- define "common.serviceport.data-extraction.http" -}}32000{{- end -}}
{{- define "common.servicehost.fs-db" -}}cassandra.ridenext-ai-platform{{- end -}}
