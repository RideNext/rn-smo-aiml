...
kubectl create namespace ridenext-ai-platform
#copy of secrets to ridenext-ai-platform namespace to enable modelmanagement service to access leofs
kubectl get secret leofs-secret --namespace=kubeflow -o yaml | sed -e 's/kubeflow/ridenext-ai-platform/g' | kubectl apply -f -
