...
create_topic kafka-1-kafka-bootstrap.ridenext-nonrt:9092 rapp-topic 10
...
echo " helm install..."
helm install --wait -f helm/global-values.yaml -n ridenext-nonrt nrt-pm-rapp helm/nrt-pm-rapp
