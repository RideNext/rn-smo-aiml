...
helm uninstall -n ridenext-nonrt  controlpanel
check_error $? controlpanel
helm uninstall -n ridenext-nonrt  nonrtricgateway
...
helm uninstall -n ridenext-nonrt nrt-pm
check_error $? nrt-pm

helm uninstall -n ridenext-nonrt nrt-base-1
check_error $? nrt-base-1

helm uninstall -n ridenext-nonrt  nrt-base-0
...
helm uninstall   -n ridenext-nonrt  strimzi-kafka-crds
check_error $? "$INST"
