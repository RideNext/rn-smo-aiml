...
echo "influxdb2_connection_bean=#class:com.influxdb.client.InfluxDBClientFactory#create('http://influxdb2.ridenext-nonrt:8086', '$INFLUXDB2_TOKEN')" > .tmp.decode.input
...
create_influxdb2_bucket influxdb2-0 ridenext-nonrt $bucket

echo " helm install..."
helm install -n ridenext-nonrt nrt-pm-kafka-connect helm/nrt-pm-kafka-connect
